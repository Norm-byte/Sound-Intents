                        ...
                        child: Row(
                          children: [
                            ...
                            if (snapshot.hasData && !isError && calculated != "None yet" && calculated != "Loading...")
                               Tooltip(
                                 message: "Use this community signal",
                                 child: InkWell(
                                   onTap: () {
                                     setState(() {
                                     ...
                                     ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Community signal copied to manual direction"), duration: Duration(seconds: 1)));
                                   },
                                   child: Container(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            _isAutoGenerated ? 'Community Signal' : 'Manual Direction',
                            style: TextStyle(
                              fontWeight: FontWeight.w600,
